...
uses
  ...
  Posix.Sched,
  {$endif POSIX}
  {$ifndef HAVE_RTLCriticalSection}
  SyncObjs,
  {$endif}
  SysUtils;
...
function InterlockedIncrement(var aValue: Long): Long; inline;
function InterlockedDecrement(var aValue: Long): Long; inline;
...
function InterlockedIncrement(var aValue: Long): Long;
begin
  result:= AtomicIncrement(aValue);
end;

function InterlockedDecrement(var aValue: Long): Long;
begin
